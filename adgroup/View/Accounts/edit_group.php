...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <?php echo $this->Form->create(null, array('url' => DOMAINAD . strtolower(basename(dirname(__FILE__))).'/edit_group', 'type' => 'post', 'name' => 'adminForm', 'inputDefaults' => array('label' => false, 'div' => false, 'legend'=> false))); ?>
            <?php echo $this->Form->input('Account.id', array()); ?>
            <table class="input">
                <tr>
                    <td class="label">Chọn nhóm:</td>
                    <td>
                        <?php echo $this->Form->input('Account.group_id', array('class' => 'text-input medium-input', 'type' => 'select','options'=>$list_cat,'default'=>$this->request->data['Account']['id'],'empty' => '-Chọn nhóm-' )); ?>
                    </td>
                </tr>
            </table>
