                    ...
                    <?php foreach ($view as $key => $value) {?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <div></div>
                                <?php if(get_extension($value['Extention']['images2']) == "swf") { ?>
                                    <embed src="<?php echo SWF_URL.$value['Extention']['images2']; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" width="200" height="150" scale="ExactFit"> </embed>
                                <?php } else { ?>
                                    <img src="<?php echo IMG_URL_ADMIN.$value['Extention']['images2']; ?>" width="100" />
                                <?php } ?>
                            </td>
