		...
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            ...
            <table class="input">
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Slideshow.order', array('class' => 'text-input small-input')); ?></td>
                </tr>-->
                <tr>
                    <td class="label">Tiêu đề:</td>
                    <td><?php echo $this->Form->input('Slideshow.name',array('class'=>'text-input medium-input','maxlength' => '250'));?></td>
                </tr>
                <tr>
                    <td class="label">Liên kết:</td>
                    <td><?php echo $this->Form->input('Slideshow.url',array('class'=>'text-input medium-input','maxlength' => '250'));?></td>
                </tr>
                <tr>
                    <td class="label">Chọn ảnh:</td>
                    <td><?php echo $this->Form->input('Slideshow.images',array('type'=>'file', 'accept'=>'image/gif,image/jpeg,image/png'));?></td>
                </tr>
                <!--<tr>
                    <td class="label">Mô tả:</td>
                    <td><?php echo $this->Form->input('Slideshow.content',array('type'=>'textarea'));?></td>
                </tr>-->
                <tr>
                    <td class="label">Trạng thái:</td>
                    <td><?php echo $this->Form->input('Slideshow.status',array('type'=>'radio','separator'=> '&nbsp;&nbsp;&nbsp;','options' => array('0'=>'Chưa Active', '1'=>'Đã Active'),'default'=>'1'));?></td>
                </tr>
            </table>
