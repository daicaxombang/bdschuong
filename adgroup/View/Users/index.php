		...
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
			...
			<table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input type="checkbox" name="check[<?php echo $value['User']['id']; ?>]" value="1" /></td>
                        <td><?php echo $key + $this->Paginator->counter('{:start}');?></td>
                        <td><?php echo $value['User']['fullname']; ?></a></td>
                        <td><?php echo $value['User']['email']; ?></a></td>
                        <td><?php echo $value['User']['phone']; ?></a></td>
                        <td><?php echo $value['User']['telephone']; ?></a></td>
                        <td><?php echo $value['User']['address']; ?></a></td>
                        
                        <td><?php echo date('d-m-Y', strtotime($value['User']['modified'])); ?></td>
                        <td>
                            <?php if ($value['User']['vip'] == 'no') {?>
                                <a href="<?php echo DOMAINAD.strtolower(basename(dirname(__FILE__)));?>/active/<?php echo $value['User']['id']; ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD ?>img/lotus/icons/cross_circle.png" alt="Kích hoạt" /></a>
                            <?php } else {?>
                                <a href="<?php echo DOMAINAD.strtolower(basename(dirname(__FILE__)));?>/close/<?php echo $value['User']['id']; ?>" title="Đóng" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD ?>img/lotus/icons/tick_circle.png" alt="Ngắt kích hoạt" /></a>
                            <?php }?>
                        </td>
