                   ...
                   <?php
                        foreach ($view as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td valign="bottom" style="text-align:center; display: none;"><img src="<?php echo DOMAIN; ?>img/<?php echo $value['Catproduct']['images']; ?>" height="100"></td>
                                ...
                                <td align="center">
                                    <?php if($value['Catproduct']['status'] == 1) { ?>
                                        <a href="<?php echo DOMAINAD?>catproducts/close/<?php echo $value['Catproduct']['id'] ?>" title="Tích vào để không hiển thị mục này"><img src="<?php echo DOMAINAD ?>img/lotus/icons/tick_circle.png" alt="Đã kích hoạt" /></a>
                                    <?php } else { ?>
                                        <a href="<?php echo DOMAINAD?>catproducts/active/<?php echo $value['Catproduct']['id'] ?>" title="Tích vào để hiển thị mục này"><img src="<?php echo DOMAINAD ?>img/lotus/icons/cross_circle.png" alt="Chưa kích hoạt" /></a>
                                    <?php } ?>
