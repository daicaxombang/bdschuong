...
<div class="content-box"><!-- Start Content Box -->
	<div class="content-box-header">
        ...
        <ul class="content-box-tabs">
            ...
            <li><a href="#tab2">Up thêm ảnh</a></li>
        </ul>
	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <table class="input">
                ...
                <tr>
                    <td class="label">Giá giảm:</td>
                    <td><?php echo $this->Form->input('Product.sale_off',array('class'=>'text-input medium-input','maxlength' => '50'));?></td>
                </tr>       
                <tr>
                ...
                <tr>
                    ...
                    <td><?php  echo $this->Form->input('Product.thongsokythuat',array('type'=>'textarea','class'=>'ckeditor-mini'));?></td>
                </tr>
                <tr>
		...
		<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                <table class="input">
                    <tr>
                        ...
                        <td><?php echo $this->Form->input('Product.title_seo',array('class'=>'text-input large-input','maxlength' => '250'));?></td>
                    </tr>
                    <tr>
