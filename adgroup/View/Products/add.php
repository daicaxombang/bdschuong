		...
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <table class="input">
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Product.images',array('type'=>'file', 'accept'=>'image/gif,image/jpeg,image/png'));?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Product.code',array('class'=>'text-input medium-input','maxlength' => '50'));?></td>
                </tr> 
                <tr>
                    ...
                    <td>
                        <ul class="mn_size_color">
                            <?php foreach($list_size as $value){?>
                                <li>
                                    <input type="checkbox" name="size[]" value="<?php echo $value['Exttmp']['id'];?>" />
                    ...
                    <td>
                        <ul class="mn_size_color">
                            <?php foreach($list_color as $value){?>
                                <li>
                                    <input type="checkbox" name="color[]" value="<?php echo $value['Exttmp']['id'];?>" />
                                    <?php echo $value['Exttmp']['name'];?>
                                    <div style="clear: both;"></div>
                                </li>
                            <?php }?>
