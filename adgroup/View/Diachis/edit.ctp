...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            ...
            <?php echo $this->Form->input('Diachi.id', array()); ?>
            <table class="input">
                <tr>
                    <td class="label">Name</td>
                    <td><?php echo $this->Form->input('Diachi.name',array('class'=>'text-input medium-input','maxlength' => '250'));?></td>
                </tr>
                <tr>
                    <td class="label">Nhóm:</td>
                    <td><?php echo $this->Form->input('Diachi.tinhthanh_id', array('type'=>'select', 'options'=>$tinhthanh, 'empty' => '---Chọn nhóm---'));?></td>
                </tr>
                <tr>
                    <td class="label">Địa chỉ:</td>
                    <td><?php echo $this->Form->input('Diachi.diachi', array('type'=>'textarea'));?></td>
                </tr>
                <tr>
                    <td class="label">Phone:</td>
                    <td><?php echo $this->Form->input('Diachi.phone', array('class'=>'text-input medium-input','maxlength' => '250'));?></td>
                </tr>
            </table>
