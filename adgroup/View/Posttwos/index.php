            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo IMG_URL_PRODUCT; ?><?php echo $value['Post']['images']; ?>" /></td>
                        ...
                        <td colspan="16">
                            <div class="bulk-actions align-left">
								<select id="option" name="option">
                                    ...
                                    <option value="choose1_active">Active tin tức home</option>
                                    <option value="choose1_close">Close tin tức home</option>
                                    <option value="choose2_active">Active dịch vụ home</option>
                                    <option value="choose2_close">Close dịch vụ home</option>
