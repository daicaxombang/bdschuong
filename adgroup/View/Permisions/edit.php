...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <?php echo $this->Form->create(null, array('url' => DOMAINAD . strtolower(basename(dirname(__FILE__))).'/edit', 'type' => 'post', 'name' => 'adminForm')); ?>
            <?php echo $this->Form->input('Permision.id', array()); ?>
            <table class="input">
               	<tr>
                   	<td class="label">Tên:</td>
                    <td>
                        <?php echo $this->Form->input('Permision.name', array('class' => 'text-input medium-input', 'maxlength' => '250')); ?>
                    </td>
                </tr>
                <tr>
                   	<td class="label">Quyền:</td>
                    <td>
                        <?php echo $this->Form->input('Permision.allow', array('class' => 'text-input medium-input', 'maxlength' => '250')); ?>
                    </td>
                </tr>
            </table>
