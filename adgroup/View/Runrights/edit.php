		...
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            ...
            <table class="input">
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Extention.link',array('class'=>'text-input medium-input','maxlength' => '250'));?></td>
                </tr>
                <tr>
                    <td class="label">Chọn file:</td>
                    <td><?php echo $this->Form->input('Extention.images',array('type'=>'file', 'accept'=>'image/gif,image/jpeg,image/png,application/x-shockwave-flash'));?></td>
                </tr>
                <tr>
