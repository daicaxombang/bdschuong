                   ...
                   <?php
                        foreach ($view as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td valign="bottom" style="text-align:center;"><?php if($value['Catproduct']['images1']){ ?><img src="<?php echo DOMAIN; ?>img/<?php echo $value['Catproduct']['images1']; ?>" height="60" /><?php }?></td>
                                ...
                                <td align="center">
                                    <?php if($value['Catproduct']['status1'] == 1) { ?>
                                        <a href="<?php echo DOMAINAD.strtolower(basename(dirname(__FILE__)));?>/close/<?php echo $value['Catproduct']['id'] ?>/status1" title="Tích vào để không hiển thị mục này"><img src="<?php echo DOMAINAD ?>img/lotus/icons/tick_circle.png" alt="Đã kích hoạt" /></a>
                                    <?php } else { ?>
                                        <a href="<?php echo DOMAINAD.strtolower(basename(dirname(__FILE__)));?>/active/<?php echo $value['Catproduct']['id'] ?>/status1" title="Tích vào để hiển thị mục này"><img src="<?php echo DOMAINAD ?>img/lotus/icons/cross_circle.png" alt="Chưa kích hoạt" /></a>
                                    <?php } ?>
                                </td>
