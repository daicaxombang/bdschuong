	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <table class="input">
                ...
                <tr>
                    <td class="label">Hình ảnh pop-up:</td>
                    <td><?php echo $this->Form->input('Catproduct.images1',array('type'=>'file', 'accept'=>'image/gif,image/jpeg,image/png'));?></td>
                </tr>
                <tr style="display: none;">
                ...
                <tr>
                    ...
                    <td><?php echo $this->Form->input('Catproduct.status',array('type'=>'radio','separator'=> '&nbsp;&nbsp;&nbsp;','options' => array('0'=>'Chưa Active', '1'=>'Đã Active') ));?></td>
                </tr>
            </table>
            <div class="clear"></div>
		</div> <!-- End #tab1 -->       
