...
class PosttwosController extends AppController {

    public $name = 'Posttwos';
    public $uses = array('Post');
    
    public $type = 'newtwo';
    public $type_cat = 'newtwo';
    ...
    public function beforeFilter() {
        ...
        /*$list = $this->Post->find('all', array(
            'conditions' => array('Post.id' => array(1,2,3,4,5,6))
        ));
        //pr($list); die;
        foreach($list as $value){
            $this->Post->create();
            $value['Post']['id'] = null;
            $value['Post']['cat_id'] = 21;
            $this->Post->save($value['Post']);
        }*/
    }
