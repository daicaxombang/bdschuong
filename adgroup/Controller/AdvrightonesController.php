...
class AdvrightonesController extends AppController {

    public $name = 'Advrightones';
    public $uses = array('Extention');
    
    public $type = 'rightone';
    ...
    public function add() {
        if (!empty($this->request->data)) {
            ...
            if ($this->Extention->validates()) {
                ...
                $this->request->data['Extention']['user_id'] = $_SESSION['id'];
            ...
            if(isset($order['Extention']['order'])) $this->request->data['Extention']['order'] = $order['Extention']['order'] + 1 ; else $this->request->data['Extention']['order'] = 0;
    ...
    public function edit($id = null) {
        if (!empty($this->request->data)) {
            ...
            if ($this->Extention->validates()) {
                ...
                $this->request->data['Extention']['type'] = $this->type;
                $this->request->data['Extention']['user_id_edit'] = $_SESSION['id'];
