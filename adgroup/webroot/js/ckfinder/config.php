 ...
 */
 ...
 //$tmp = str_replace($_SERVER['DOCUMENT_ROOT'],'',str_replace( '\\','/',dirname(dirname(dirname(dirname(dirname(__FILE__))))) ) );
 //echo $tmp;die;
...
$path = trim(str_replace($_SERVER['DOCUMENT_ROOT'],'',str_replace( '\\','/',dirname(dirname(dirname(dirname(dirname(__FILE__))))) )),'/');
if(!empty($path)) $path .= '/';

$baseUrl = $path.'/app/webroot/upload/';
