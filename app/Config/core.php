 ...
 */
	Configure::write('Security.salt', 'adsgsfhtreuerbczxxcvnhbvmtfgjrsgrwqrewq');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '23546753243256347465475647534');
...
function shortDesc($str, $len, $charset='UTF-8'){
 ...
 function shortDesc1($str, $len, $charset='UTF-8'){
