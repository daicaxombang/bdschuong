...
<head>
    ...
    $css = array(
        ...
        '/css/root/pagination',
        '/css/menu/ddsmoothmenu.css?v='.time(),
    ...
    <script type="text/javascript">
        ...
        /*ddsmoothmenu.init({
            mainmenuid: "smoothmenu1_new", //menu DIV id
            orientation: 'h', //Horizontal or vertical menu: Set to "h" or "v"
            classname: 'navhor', //class added to menu's outer DIV
            //customtheme: ["#1c5a80", "#18374a"],
            contentsource: "markup" //"markup" or ["container_id", "path_to_menu_file"]
...
<?php if(!isset($detail_asd)) echo $this->element('slide'); ?>

<div class="main-width" style="padding-top: 30px;">
    <div class="row-fluid">
        <div class="span9">
            <?php echo $this->fetch('content'); ?>
        </div>
        <div class="span3"><?php echo $this->element('sitebar-right');?></div>
    </div>
</div>
